...
from typing import Callable, Any, Dict, List, Optional, get_type_hints, re
...
def tool_action(name: str = None, description: str = None):
    """
    装饰器：标记一个方法为可展开的工具（action），类似于自定义注解
...
class Tool(ABC):
    ...
    def get_expanded_tools(self) -> Optional[List['Tool']]:
        ...
        子类可以重写此方法提供自定义的展开逻辑
        :return: 如果工具支持展开，返回子工具列表；否则返回 None
        """
        ...
        for name, method in inspect.getmembers(self, predicate=inspect.ismethod):
            if hasattr(method, '_tool_action'):
...
class AutoGeneratedTool(Tool):
    """
    自动生成的工具，从方法签名和docstring中自动提取参数
    """
    ...
    def __init__(self, parent: Tool, method: Callable, name: str = None, description: str = None):
        ...
        :param parent: 父工具实例
        :param method: 被装饰的方法
        :param name: 工具名称（如果为 None，从方法名生成）
        :param description: 工具描述（如果为 None，从 docstring 提取）
        """
        self.parent = parent
        self.method = method

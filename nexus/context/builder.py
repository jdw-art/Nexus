...
class ContextBuilder:
    """
    上下文构建器 - GSSC流水线
    Gather-Select-Structure-Compress: 获取-选择-结构化-压缩
    ...
    def build(
        ...
        :param additional_packets: 额外的上下文包
        :return: 结构化上下文字符串
        """
        # 构建GSSC流水线
    ...
    def _gather(
            ...
            additional_packets: Optional[List[ContextPacket]]
    ) -> List[ContextPacket]:
        """Gather：收集候选信息"""
        packets = []

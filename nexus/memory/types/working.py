...
class WorkingMemory(BaseMemory):
    ...
    def __init__(self, config: MemoryConfig, storage_backend=None):
        ...
        self.max_age_minutes = getattr(self.config, 'working_memory_max_age_minutes', 120)
    ...
    def forget(self, strategy: str = "importance_based", threshold: float = 0.1, max_age_days: int = 1) -> int:
        """
        工作记忆遗忘机制
        :param strategy: 遗忘策略（importance_based，time_based，capacity_based）
        :param threshold: 执行阈值
        :param max_age_days: 最长记忆时效
        :return:
        """
        forgotten_count = 0

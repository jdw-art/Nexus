...
from ..storage import SQLiteDocumentStore, QdrantVectorStore, QdrantConnectionManager
...
class EpisodicMemory(BaseMemory):
    ...
    def update(self, memory_id: str, content: str = None,
        ...
        """更新情景记忆，SQLite作为权威记忆，Qdrant按需重嵌入"""
        updated = False

...
class ReActAgent(Agent):
    ...
    def __init__(
        ...
        :param name: Agent名称
        :param llm: LLM实例
        :param tool_registry: 工具注册表（可选，如果不提供则创建空的工具注册表）
        :param system_prompt: 系统提示词
        :param config: 配置对象
        :param max_steps: 最大执行步数
        :param custom_prompt: 自定义提示词模版
        """
    ...
    def add_tool(self, tool):
        ...
        添加工具到工具注册表
        支持MCP工具的自动展开
        :param tool: 工具实例(可以是普通Tool或MCPTool)
        :return:
        """
        # 检查是否是MCP工具

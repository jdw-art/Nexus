...
def _map_parameter_type(param_type: str):
...
class FunctionCallAgent(Agent):
    ...
    def __init__(
        ...
        """
        初始化FunctionCallAgent
        :param name: Agent名称
        :param llm: LLM实例
        :param system_prompt: 系统提示词
        :param config: 配置对象
        :param tool_registry: 工具注册表
        :param enable_tool_calling: 是否开启工具调用功能
        :param default_tool_choice: 默认调用的工具
        :param max_tool_iterations: 最大迭代次数
        """

...
from nexus.agents import SimpleAgent
from nexus.context.builder import ContextBuilder, ContextConfig
from nexus.core import Message, NexusLLM
...
class ContextAwareAgent(SimpleAgent):
    ...
    def __init__(self, name: str, llm: NexusLLM, **kwargs):

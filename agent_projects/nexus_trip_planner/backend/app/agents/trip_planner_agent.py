...
from agent_projects.nexus_trip_planner.backend.app.models.schemas import TripRequest, TripPlan, DayPlan, Attraction, \
    Location, Meal
from agent_projects.nexus_trip_planner.backend.app.services.llm_service import get_llm
from nexus import SimpleAgent
from nexus.tools import MCPTool
...
class MultiAgentTripPlanner:
    ...
    def plan_trip(self, request: TripRequest) -> TripPlan:
        ...
        try:
            ...
            traceback.print_exc()
            self._create_fallback_plan(request)
    ...
    def _build_planner_query(self, request: TripRequest, attractions: str, weather: str, hotels: str = "") -> str:
        """构建行程规划查询"""
        query = f"""请根据一下信息生成{request.city}的{request.travel_days}天旅行计划:
